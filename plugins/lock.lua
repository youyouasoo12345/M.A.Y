...
local group = load_data('bot/group.json')
  ...
  if group_link_lock == 'yes' then
    pm =  'اهلا صديقي الروابط مقفوله فعلا  ¦👨‍🔧✅'
  tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
else
    group[tostring(target)]['settings']['lock_link'] = 'yes'
    save_data(_config.group.data, group)
    pm =  'اهلا صديقي تم قفل الروابط ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_username_lock == 'yes' then
    pm =  'اهلا صديقي المعرف مقفوله فعلا  ¦👨‍🔧✅'
  tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
else
    group[tostring(target)]['settings']['lock_username'] = 'yes'
    save_data(_config.group.data, group)
    pm =  'اهلا صديقي تم قفل المعرف ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_edit_lock == 'yes' then
    pm =  'اهلا صديقي التعديل مقفوله فعلا  ¦👨‍🔧✅'
  tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
else
    group[tostring(target)]['settings']['lock_edit'] = 'yes'
    save_data(_config.group.data, group)
    pm =  'اهلا صديقي تم قفل التعديل 👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_fwd_lock == 'yes' then
    pm =  'اهلا صديقي التوجيه مقفوله فعلا  ¦👨‍🔧✅'
  tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
else
    group[tostring(target)]['settings']['lock_fwd'] = 'yes'
    save_data(_config.group.data, group)
    pm =  'اهلا صديقي تم قفل التوجيه¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_link_lock == 'no' then
    pm =   'صديقي الروابط مفتوحه فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['lock_link'] = 'no'
    save_data(_config.group.data, group)
    pm =  'اهلا صديقي تم فتح الروابط ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_username_lock == 'no' then
    pm =  'صديقي المعرف مفتوح فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['lock_username'] = 'no'
    save_data(_config.group.data, group)
    pm= 'اهلا صديقي تم فتح المعرف ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_edit_lock == 'no' then
    pm =  'صديقي التعديل مفتوح بالفعل  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['lock_edit'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح التعديل  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_fwd_lock == 'no' then
    pm = 'صديقي التعديل مفتوح فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['lock_fwd'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح التوجيه ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_spam_lock == 'yes' then
    pm =  'صديقي التكرار مقفول فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['lock_spam'] = 'yes'
    save_data(_config.group.data, group)
    pm= 'اهلا صديقي تم قفل التكرار  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if group_spam_lock == 'no' then
    pm =  'صديقي التكرار مفتوح فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['lock_spam'] = 'no'
    save_data(_config.group.data, group)
    pm = 'اهلا صديقي تم فتح التكرار  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_all  == 'yes' then
    pm =  'صديقي جميع الاعدادات مقفوله فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_all'] = 'yes'
    save_data(_config.group.data, group)
    pm= 'اهلا صديقي تم قفل كل الاعدادات  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  local mute_all = group[tostring(target)]['settings']['mute_all']
  if mute_all  == 'no' then
    pm =  'اهلا صديقي تم فتح كل الاعدادات  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_all'] = 'no'
    save_data(_config.group.data, group)
    pm= 'صديقي جميع الاعدادات مفتوحه فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_all  == 'yes' then
    pm =  'صديقي الصور مقفوله فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_photo'] = 'yes'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم قفل الصور  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  local mute_all = group[tostring(target)]['settings']['mute_photo']
  if mute_all  == 'no' then
    pm =  'صديقي الصور مفتوحه فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_photo'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح الصور  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_video  == 'yes' then
    pm =  'صديقي الفيديو مقفول فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_video'] = 'yes'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم قفل الفيديو ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_video  == 'no' then
    pm =  'صديقي الفيديو مفتوح فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_video'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح الفيديو ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_gif  == 'yes' then
    pm =  'صديقي المتحركه مقفوله فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_gif'] = 'yes'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم قفل المتحركه ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  local mute_gif = group[tostring(target)]['settings']['mute_gif']
  if mute_gif  == 'no' then
    pm =  'صديقي المتحركه مفتوحه فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_gif'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح المتحركه ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_voice  == 'yes' then
    pm =  'صديقي الصوتيات مقفوله فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_voice'] = 'yes'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم قفل الصوتيات ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_voice  == 'no' then
    pm =  'صديقي الصوتيات مفتوحه فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_voice'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح الصوتيات ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_audio  == 'yes' then
    pm =  'صديقي الصوت مقفول فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_audio'] = 'yes'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم قفل الصوت ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_audio  == 'no' then
    pm =  'صديقي الصوت مفتوح فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_audio'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح الصوت ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_document  == 'yes' then
    pm =  'صديقي الملفات مقفوله فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_document'] = 'yes'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم قفل الملفات ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
...
local group = load_data('bot/group.json')
  ...
  if mute_document  == 'no' then
    pm =  'صديقي الملفات مفتوحه فعلا  ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  else
    group[tostring(target)]['settings']['mute_document'] = 'no'
    save_data(_config.group.data, group)
    pm=  'اهلا صديقي تم فتح الملفات ¦👨‍🔧✅'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
  end
end
local function group_settings(msg, target)
local group = load_data('bot/group.json')
pm = '🔧اهلا صديقي في اعدادات سورس DEV FAEDER  ¦👨‍🔧'
